...
$cfg['blowfish_secret']					= 'P}]\\+(\\6<T=Rws@2sENGisY9h`jpG5z\'' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_xpgnAYBWqvSMX019VdetI6a/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://testing.elvirainfotech.live/wp-admin/?rand=30720215&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://testing.elvirainfotech.live/wp-admin/?rand=64749061&pma_logout=1';
