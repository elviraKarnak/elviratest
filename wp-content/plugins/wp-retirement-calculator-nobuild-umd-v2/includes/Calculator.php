...
class Calculator {
    public function run(array $input): array {
        ...
        // Build a flat income series from retire_age to longevity_age (today's dollars)
        $income_series = [];
        for ($a = $retire_age; $a <= $longevity_age; $a++) {
            $income_series[] = [ $a, round($total_income_today, 2) ];
        }
